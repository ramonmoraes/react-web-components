...
class MenuMobile extends Component {
    ...
    render() {
        ...
        const containerClass = ( active ) ? 'side-nav-container side-nav-container-overlay' : 'side-nav-container';
        const navClass = 'side-nav ' + (( active ) ? 'side-nav-enabled' : 'side-nav-disabled');
        
        return (
            <nav className='sticky-top'>
                <div className ='top-menu'>
                    <button onClick={this.showMenu}> <b> MENU </b> </button>
                </div>
